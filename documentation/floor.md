...
* height: float
* frame_width: float
* corner_chamfer: float|None
* corner_fillet: float|None
...
* [source](../src/cqterrain/floor/FramedFloor.py)
* [example](../example/floor/framed_floor.py)
* [stl](../stl/floor_framed_floor.stl)
